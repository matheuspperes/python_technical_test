...
class Waits:
    ...
    def wait_clickable(self, locator:dict, driver:WebDriver, time=10):
        '''
    ...
    def wait_visibility(self, locator:dict, driver:WebDriver, time=10):
        '''
    ...
    def wait_alert(self, driver:WebDriver, time=10):
        '''
    ...
    def wait_frame_and_switch(self, locator:dict, driver:WebDriver, time=10):
        '''
